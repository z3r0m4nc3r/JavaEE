...
<body class="w3-blue-grey">
	<div class="w3-container">
		...
		<div class="w3-responsive w3-light-grey w3-opacity w3-round-large">
			<h1>Alumnos</h1>
			<form action="FrontController?option=doSeleccionCursoMatricular"
				method="Post">
				...
				</select> <br /> <input type="submit" value="Siguiente" class="w3-btn w3-black w3-ripple w3-round-large"/>
			</form>
			<br />
			<br />
