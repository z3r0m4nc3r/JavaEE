...
public class ConsultarMatriculasController {
	...
	public String matriculas(Model model, @RequestParam("fecha1") String fecha1, @RequestParam("fecha2") String fecha2) {
		model.addAttribute("matriculas", service.consultarMatriculas(fecha1,fecha2));
		return "matriculas";
	}
